...
@Injectable()
export class StockServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(id: number): Observable<StockDto> {
        let url_ = this.baseUrl + "/api/services/app/StockService/Get?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<StockDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<StockDto>><any>Observable.throw(response_);
        });
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<StockDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? StockDto.fromJS(resultData200) : new StockDto();
            return Observable.of(result200);
            });
        } else if (status === 401) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<StockDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfStockDto> {
        let url_ = this.baseUrl + "/api/services/app/StockService/GetAll?";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfStockDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(input: StockDto | null | undefined): Observable<StockDto> {
        let url_ = this.baseUrl + "/api/services/app/StockService/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    update(input: StockDto | null | undefined): Observable<StockDto> {
        let url_ = this.baseUrl + "/api/services/app/StockService/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/StockService/Delete?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
...
export class PagedResultDtoOfStockDto implements IPagedResultDtoOfStockDto {
    ...
    clone(): PagedResultDtoOfStockDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfStockDto();
        result.init(json);
        return result;
